...
- **Authentication**: OAuth 2.0 Bearer tokens. `[OPIN-VN]`: OPIN's spec is silent on auth. OAuth 2.0 is adopted with two role scopes that mirror OPIN's two declared tags:
